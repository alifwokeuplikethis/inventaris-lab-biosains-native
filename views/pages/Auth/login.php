  ...
  <div class="container-fluid flex-grow-1 d-flex align-items-center justify-content-center py-5">
    <div class="row d-flex justify-content-center align-items-center w-100">
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        ...
        <a href="/inventory-revisi/?action=login" class="btn btn-google btn-lg w-100 d-flex align-items-center justify-content-center fw-bold rounded-pill">
        ...
        <form method="POST" action="<?= BASE_URL ?>/?action=register">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="email" id="whitelistEmail" name="email" class="form-control form-control-lg" placeholder="contoh@gmail.com" required />
          </div>

          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" class="btn btn-custom-dark btn-lg w-100 rounded-pill">Ajukan Email</button>
          </div>
        </form>
